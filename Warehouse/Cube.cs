...
{
    [Serializable()]
    public class Cube : ICalculate,I3DStorageObject
    {
        ...
        public Cube(string id,string description,long weight,bool isFragile,int sides)
        {
            this.id = id;
        ...
        public object Clone()
        {
            Cube cube = new Cube(ID, Description, Weight,IsFragile,Sides);
            return cube;
        }
    }
}
